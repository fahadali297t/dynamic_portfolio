$(function () {
    ...
    $(document).ready(function () {
        // Apply saved theme on load (default = dark-theme)
        ...
        function updateDarkModeIcon(theme) {
            if (theme === "dark-theme") {
                ...
                $(".dark-mode-icon i").attr("class", "bi bi-moon-fill"); // moon
            }
        }

        // Optional: theme switcher buttons
        ...
        $("#SemiDarkTheme").on("click", function () {
            ...
            updateDarkModeIcon("semi-dark");
        });
        $("#MinimalTheme").on("click", function () {
            $("html").attr("class", "minimal-theme");
            localStorage.setItem("theme", "minimal-theme");
            updateDarkModeIcon("minimal-theme");
        });
    });
